...
cmd:option('-finetune_cnn_after', 1000, 'After what iteration do we start finetuning the CNN? (-1 = disable; never finetune, 0 = finetune from start)')
...
local function lossFun()
  ...
  -- and lets get out!
  local losses = { total_loss = loss , sth_loss = sth_err}
  return losses
end
...
while true do  
  ...
  print(string.format('iter %d total_loss: %f;skipthought_loss: %f', iter, losses.total_loss,losses.sth_loss))
